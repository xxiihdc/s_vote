...
**Tests**: Tests are MANDATORY for constitution compliance. Every user story must include
...
- [ ] T017 [US1] [Observability] Add structured logging and correlation IDs for user story 1 operations
- [ ] T018 [US1] [Security] Verify/adjust Supabase RLS policies for user story 1 data paths
- [ ] T019 [US1] [Docker] Validate user story 1 in Docker build/start workflow
...
- [ ] T025 [US2] [Security] Verify/adjust RLS and role scopes for user story 2
- [ ] T026 [US2] [Observability] Add structured logging for user story 2 runtime path
...
- [ ] T033 [US3] [Security] Verify/adjust RLS and role scopes for user story 3
- [ ] T034 [US3] [Observability] Add structured logging for user story 3 runtime path
...
- [ ] TXXX [P] Additional unit tests for regression hardening in tests/unit/
